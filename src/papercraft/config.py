...
class ModelPolicy(BaseModel):
    ...
    architect: str = "gemini-3.6-flash"
    critic: str = "gemini-3.6-flash"
    writer: str = "gemini-3.6-flash"
    extractor: str = "gemini-3.5-flash-lite"
    image: str = "gemini-3.1-flash-image"
    embedding: str = "gemini-embedding-001"
    version: str = "2026-08"

    @field_validator("architect", "critic", "writer", "extractor", "image", "embedding")
    @classmethod
...
class RetryPolicy(BaseModel):
    ...
    maximum_delay_seconds: float = Field(default=30.0, ge=0, le=300)
